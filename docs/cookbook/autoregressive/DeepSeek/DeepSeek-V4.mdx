...
FreeToken keeps DeepSeek-V4-Flash experts in pinned host memory and streams two
alternating layers to an SM120 GPU. It is disabled by default and requires a
disaggregated TP1/EP1/DP1 prefill worker, `flashinfer_mxfp4`, and disabled CUDA
graphs and batch overlap.
